...
public class Rocket extends GameObject {
    ...
    List<int[][]> downFireList = Arrays.asList(ShapeMatrix.FIRE_DOWN_1, ShapeMatrix.FIRE_DOWN_2, ShapeMatrix.FIRE_DOWN_3);
    List<int[][]> sideFireList = Arrays.asList(ShapeMatrix.FIRE_SIDE_1, ShapeMatrix.FIRE_SIDE_2);
